...
table_name= dbutils.jobs.taskValues.get(taskKey = "Featurization", key = "fs_table_name", default = "stockprhive_metastore.stockpred_db.stockpred_dbd300e5ed_dbebfee8", debugValue = "hive_metastore.stockpred_db.stockpred_dbd300e5")
